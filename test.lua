...
Bac1:Label("If you reuse the device, you can turn off the function!")
Bac1:Seperator(" Language Vietnam ")
Bac1:Label("Tự động tham gia lại máy chủ sau 25 phút")
Bac1:Label("Chỉ sử dụng khi treo máy")
Bac1:Label("Nếu bạn sử dụng lại thiết bị, bạn có thể tắt chức năng!")
...
Bac0:Toggle("Bypass Anti-cheat",true,function(value)
 _G.Bac4 = value
 end)
