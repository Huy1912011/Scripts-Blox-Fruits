...
local HenryImageUI = Instance.new("ImageLabel")
        ...
        HenryImageUI.Image = "http://www.roblox.com/asset/?id=12511245920"
...
Bac0:Toggle("Bypass Anti-Chest",false,function(value)
 _G.Bac1 = value
 end)
 
 local test = task.delay(3, function()
 print("test")
 end)

	        if _G.Bac1 == false then
