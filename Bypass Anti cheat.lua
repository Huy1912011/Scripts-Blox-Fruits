...
local Bac1 = Library:Tab("Information")
local Bac0 = Library:Tab("Setting")
Bac1:Seperator(" Script By Henry ")
Bac1:Label("Auto rejoin the server after 25 minutes")
Bac1:Label("Use only when the device is not in use")
Bac1:Label("The function auto activates when the script is opened")
Bac1:Label("If you use the device again, you can turn it off!")
Bac1:Seperator(" Language Vietnamese ")
Bac1:Label("Tự động tham gia lại máy chủ sau 25 phút")
Bac1:Label("Chỉ sử dụng khi không sử dụng thiết bị")
Bac1:Label("Chức năng tự động kích hoạt khi script được mở")
Bac1:Label("Nếu bạn sử dụng lại thiết bị, bạn có thể tắt nó đi!")
Bac0:Seperator(" Script By Henry ")
...
Bac0:Button("Bypass Anti-cheat [ON]",function()
 Bac3 = coroutine.create(Bac2)
 coroutine.resume(Bac3)
 end)
 
Bac0:Button("Bypass Anti-cheat [OFF]",function()
