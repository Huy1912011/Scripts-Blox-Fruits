print("]------- Initializing TrigonTest v0.04o -------[")
...
if keyless then
	...
	if PandaAuth then
		...
		if not success then
			keyless = true
			print("Failed to retrieve AuthLink. PandaAuth Error, TrigonTest is Keyless!!")
		end
	else
		keyless = true
		print("PandaAuth Error, TrigonTest is Keyless!!")
	end
end 
	...
	pcall(function()		
		if Settings.autoexec then  
			...
			if next(files) == nil then
				warn("\"Autoexec2\" folder is empty.")
			else
...
function loadtopbar()
	...
	if game.PlaceId == 10449761463 then
		topbar("TrigonTest", "rbxassetid://15844306310", false) 
	else
		topbar("TrigonTest", "rbxassetid://15844306310", true)
	end
	print("loaded")
end
...
function loader()
    ...
    TrigonLoader.TextLabel_3.Text = "Need Support? Join TrigonTest Discord Server!"
...
trigok.Title_5.Text = "Hide TrigonTest on Launch"
...
trigok.subTitle_1.Text = "TrigonTest UI will not show at start."
...
trigok.Title_6.Text = "Enable TrigonTest Desktop Connection"
...
trigok.ScriptBox.Text = "-- We recommend only uisng loadstrings | TrigonTest Mobile v0.03 {Beta}"
