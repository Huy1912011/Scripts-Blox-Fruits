...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Henry chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Henry", HidePremium = false, IntroText = "Henry⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Henry SCRIPT")
W:AddLabel("DiscordHenry")
local Section = W:AddSection({
    Name = "Status"
})
