...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.Image = "http://www.roblox.com/asset/?id=13133860620"
...
Logo.Image = "rbxassetid://11718256532"
...
local postog12 = Instance.new("UIStroke")
 ...
 ImageLabel.Image = "rbxassetid://11718256532"
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
	...
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
		  	if _G.Teleport_to_Seabeast or _G.Teleport_to_Player then
...
spawn(function()
    ...
    local P = Library:Tab("Player","rbxassetid://6026568198")
    local Teleport = Library:Tab("Teleport","rbxassetid://6026568198")
    local Race = Library:Tab("Race V4","rbxassetid://6026568198")
    local Shop = Library:Tab("Shop","rbxassetid://6026568198")
    local Misc = Library:Tab("Misc","rbxassetid://6026568198")
    local Anti = Library:Tab("Anti","rbxassetid://6026568198")
...
spawn(function()
 ...
 Teleport:Toggle("Teleport to Seabeast",_G.Teleport_to_Seabeast,function(value)
 _G.Teleport_to_Seabeast = value
StopTween(_G.Teleport_to_Seabeast)
end)


spawn(function()
    while wait() do
		if _G.Teleport_to_Seabeast then
			pcall(function()
...
if World3 then
    ...
    Teleport:Button("Chocolate Island",function()
        if BypassTP then
            ...
            topos(CFrame.new(156.896484, 30.5935211, -12662.7031, -0.573599219, 0, 0.81913656, 0, 1, 0, -0.81913656, 0, -0.573599219))
        end
    ...
    Teleport:Button("Haunted Castle",function()
        if BypassTP then
            ...
            topos(CFrame.new(-9530.61035, -132.860657, 5763.13477))
        end
    ...
    Teleport:Button("Mini Sky",function()
        if BypassTP then
            ...
            topos(CFrame.new(-263.66668701172, 49325.49609375, -35260))
        end
...
Misc:Button("Color Haki",function()
 game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
  ...
  Misc:Toggle("Infinite Jump", true, function(State)
Infinite = State
...
Misc:Toggle("⚔️Fast Attack",nil,function(value)
...
Misc:Toggle("⚔️Fast Attack [Player]",nil,function(value)
        _G.FastAttackPlayer = value
    end)
...
spawn(function()
    ...
    if _G.FastAttackPlayer then
        ...
        pcall(function()
            ...
            getupvalues(CombatFramework)[2]['activeController'].hitboxMagnitude = 9999
...
Misc:Toggle("⚔️Auto Attack",nil,function(value)
        _G.AutoAttack = value
    end)

local CombatFrameworkNew = require(game:GetService("Players").LocalPlayer.PlayerScripts.CombatFramework)
local CameraNew = require(game.ReplicatedStorage.Util.CameraShaker)
CameraNew:Stop()
spawn(function()
    game:GetService("RunService").Stepped:Connect(function()
    if _G.AutoAttack then
        if getupvalues(CombatFrameworkNew)[2]['activeController'].timeToNextAttack then
        pcall(function()
            getupvalues(CombatFrameworkNew)[2]['activeController'].hitboxMagnitude = 9999
            getupvalues(CombatFrameworkNew)[2]['activeController']:attack()
        end)
    end
end
end)
...
Anti:Toggle("Anti Cheat Bypass(❗Do Not Turn Off❗)", true, function(value)
  _G.SafeFarm = value
CheckAntiCheatBypass()
