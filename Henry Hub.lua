...
Misc:Button("Stop Teleport",function()
  topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
  _G.Clip = false
  end)
...
Misc:Toggle("⚔️Fast Attack [Player]",true,function(value)
...
spawn(function()
    ...
    if _G.FastAttackPlayer then
        ...
        pcall(function()
            ...
            getupvalues(CombatFramework)[2]['activeController'].humanoid.AutoRotate = true
