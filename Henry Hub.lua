...
Main:Toggle("Teleport To Spawn Fruit",false,function(value)
 _G.Grabfruit = value
end)
...
Misc:Toggle("Fast Attack [2]",true,function(value)
...
game:GetService("VirtualUser"):ClickButton1(Vector2.new(0,1,0,1),game:GetService("Workspace").Camera.CFrame)
            end)
        end
    end)
end)

Misc:Toggle("Remove Fog",true,function(value)
        RemoveFog = value
