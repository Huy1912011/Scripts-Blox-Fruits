...
coroutine.wrap(function()
    game:GetService("RunService").Stepped:Connect(function()
        if getupvalues(FastAttackVip)[2]['activeController'].timeToNextAttack then
            getupvalues(FastAttackVip)[2]['activeController'].timeToNextAttack = 0
            getupvalues(FastAttackVip)[2]['activeController'].hitboxMagnitude = 1000
            getupvalues(FastAttackVip)[2]['activeController']:attack()
        end
    end)
end)()