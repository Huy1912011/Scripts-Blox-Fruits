...
H:Button("Copy Youtube Henry Hub",function()
setclipboard("https://youtube.com/@nomadicoof789")
end)

H:Line()
H:Label("New Update Log")
H:Label("[+] Fix Fast Attack|10/3/2567|12:15")
...
H:Label("[+] Auto Farm No Quest|2/1/2567|20:28")
H:Label("[+] Auto Set Frame Mon (CheckMon)|9/1/2567|20:28")
H:Label("[+] Esp Kisune|14/1/2567|08:08")
H:Label("[+] Auto Get Fruit Inventory|20/2/2567|15:30")
H:Label("[+] Fix Fast Attack|10/3/2567|12:15")
...
Main:Seperator("Farm")
    ...
    local Bac0 = task.wait(20, function()
    game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
Main:Toggle("Bypass Anti-Chest",false,function(value)
    _G.Bac0 = value
    if _G.Bac0 == false then
            task.cancel(Bac0)
        end
end)

Main:Label("Auto Rejoin Server After 25 Minutes (For When You Hang Up)")
...
spawn(function()
    ...
    Main:Toggle("Fast Attack Super Fast [Trun on Fast Attack to use!!] ",_G.NotDeley,function(value)
        _G.NotDeley = value
    end)      
